...
public class Test_Area {
	...
	RectangleArea A2 = rect(new Vec3(0.5f,0,0), new Vec3(2,0,1)) ;
	RectangleArea A3 = rect(new Vec3(-0.5f,0,0), new Vec3(2,0,1)) ;
	RectangleArea A4 = rect(new Vec3(-0.5f,0,0), new Vec3(2.5f,0,1)) ;
	RectangleArea A5 = rect(new Vec3(2,0,0), new Vec3(4,0,2)) ;
